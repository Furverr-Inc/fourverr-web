  ...
  return (
    <>
      <Box sx={{
        ...
        background: isDark ? BG_DARK : BG_LIGHT, position: 'relative',
      }}>
        <Button
        ...
        <Box sx={{
          ...
          <Typography variant="caption" display="block" align="center" sx={{
            ...
            {t.createAccountTitle || (isEn ? 'Create account' : 'Crear Cuenta')}
          </Typography>
          ...
          <Box component="form" onSubmit={handleSubmit}>
            ...
            {form.password && (
              <Box sx={{ mb: 1.5 }}>
                ...
                <Typography variant="caption" sx={{ color: STRENGTH_COLOR[strength], fontWeight: 600 }}>
                  {(isEn ? STRENGTH_LABEL_EN : STRENGTH_LABEL_ES)[strength]}
                </Typography>
              </Box>
            )}
            ...
            >
              {t.register || (isEn ? 'Create account' : 'Crear cuenta')}
            </Button>

            <Box textAlign="center">
              <Typography variant="body2"
                sx={{ color: isDark ? 'rgba(200,202,212,0.55)' : 'rgba(13,17,39,0.5)' }}>
                {t.alreadyHaveAccount || (isEn ? 'Already have an account?' : '¿Ya tienes cuenta?')}{' '}
                <Link component={RouterLink} to="/login" underline="hover"
                  sx={{ color: PERIW, fontWeight: 700 }}>
                  {t.signIn || (isEn ? 'Sign in' : 'Inicia sesión')}
                </Link>
              </Typography>
            </Box>
          </Box>
