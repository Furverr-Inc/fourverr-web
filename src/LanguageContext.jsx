...
export const translations = {
  es: {
    ...
    stripeConnectTitle: 'Pagos directos con Stripe',
    stripeConnectDesc: 'Conecta tu cuenta de Stripe para recibir el 90% de cada venta directo a tu banco. Sin conexión, los pagos se acreditan manualmente.',
    stripeConnectBtn: 'Conectar cuenta de Stripe',
    stripeConnectPending: 'Completar configuración en Stripe',
    stripeConnectActive: 'Cuenta de Stripe activa ✓',
    stripeConnectLoading: 'Redirigiendo a Stripe...',
  ...
  en: {
    ...
    stripeConnectTitle: 'Direct payouts with Stripe',
    stripeConnectDesc: 'Connect your Stripe account to receive 90% of each sale directly to your bank. Without connection, payouts are processed manually.',
    stripeConnectBtn: 'Connect Stripe account',
    stripeConnectPending: 'Complete Stripe setup',
    stripeConnectActive: 'Stripe account active ✓',
    stripeConnectLoading: 'Redirecting to Stripe...',
